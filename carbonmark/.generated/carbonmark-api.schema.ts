export default {
  ...
  "schema": {
  "type": "string",
  "pattern": "^(VCS|PURO|GS|ICR)-\\d+-(19\\d{2}|20\\d{2})$|^ICR-(?:[A-Z]+-\\d+-(\\d+-)?\\d+-[A-Z]-\\d+-(19\\d{2}|20\\d{2})|[A-Z]+-\\d+-\\d+-\\d+-[A-Z]-\\d+-\\d+)$"
  },
  ...
  "servers": [
  {
  "url": "https://v2.0.0-14.api.carbonmark.com"
  }
  ],
  "externalDocs": {
